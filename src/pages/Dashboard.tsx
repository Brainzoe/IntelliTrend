      ...
      <main className="flex-1 px-6 py-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow hover:shadow-lg transition p-6">
            ...
            <a href="#" className="block mt-4 w-full text-center bg-blue-600 text-white py-2 rounded-lg hover:bg-blue-700 transition">
              Go to Overview
            </a>
          </div>

          {/* Repeat for Reports, Analytics, Messages, Settings with their icons */}
          {/* Reports */}
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow hover:shadow-lg transition p-6">
            <h2 className="flex items-center gap-2 text-lg font-semibold text-gray-800 dark:text-gray-100">
